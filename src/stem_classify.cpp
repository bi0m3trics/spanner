//  ============================================================================
//  spanner – stem_classify.cpp
//
//  C_ransac_stem_slices():
//    For every tree in a segmented point cloud, iterate over height slices and
//    fit a RANSAC circle to stem-candidate points within each slice.  Returns a
...
//   z_min, z_max   – height window to search for stem points (above ground)
...
// [[Rcpp::export]]
DataFrame C_ransac_stem_slices(
    NumericVector X,
    NumericVector Y,
    NumericVector Z,
...
#pragma omp parallel for schedule(dynamic, 1)
    ...
    for (int t = 0; t < n_trees; ++t) {
        ...
        for (int s = 0; s < n_slices; ++s) {
            ...
            // Collect stem-candidate points in this slice
